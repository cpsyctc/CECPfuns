...
#'   and my own biggest research programme, which overlaps with Emily's work, is the CORE system:
#'   <https://www.corestemtrust.org.uk/> and a web site about my non-CORE work is slowly building (from a much earlier one)
#'   at <https://www.psyctc.org/psyctc/> and my personal site is <https://www.psyctc.org/pelerinage2016>.
#'
"_PACKAGE"
